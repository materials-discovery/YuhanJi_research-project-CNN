%% Plot the fits incluiding the test data. 
% Note: The test data is used as a final validation step, and should only
% be done when you are happy with the performance on the
